...
def show_graphs(patch_size):
    for network in networks:
        for name in names:
            ...
            path = results_path+'\\{}\\{}\\patch_replacement_nonoverlapping_full\\patch_size{}\\{}\\{}.npy'
            ...
            plt.savefig(analysis_results_path+"\\nonoverlapping full patch replacement\\{}\\{}_patchSize{}.png".format(network,name,patch_size))
            plt.show()
