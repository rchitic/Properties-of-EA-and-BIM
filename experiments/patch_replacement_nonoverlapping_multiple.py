		...
		for name in names:
			for order in range(1,11):
				...
				if os.path.exists(filename):
					...
					# save results
					filename_save_orig = results_loc + "/{}/{}/patch_replacement_nonoverlapping_full/patch_size{}/{}/orig{}.npy".format(attack_name,network,patch_size,name,order)
					filename_save_target = results_loc + "/{}/{}/patch_replacement_nonoverlapping_full/patch_size{}/{}/target{}.npy".format(attack_name,network,patch_size,name,order)
